 ...
 *
 */
public class REMOVENOTIFICATIONCommand extends JobCommand {

    /**
     * @param statusListener
     */
    public REMOVENOTIFICATIONCommand(StatusListener statusListener) {
        super(statusListener);
        this.id = REMOVENOTIFICATION;
