 ...
 *
 */
public class ADDNOTIFICATIONCommand extends JobCommand {

    /**
     * @param statusListener
     */
    public ADDNOTIFICATIONCommand(StatusListener statusListener) {
        super(statusListener);
        this.id = ADDNOTIFICATION;
