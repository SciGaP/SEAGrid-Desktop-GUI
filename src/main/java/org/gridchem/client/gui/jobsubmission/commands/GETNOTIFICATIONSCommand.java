 ...
 *
 */
public class GETNOTIFICATIONSCommand extends JobCommand {

    /**
     * @param statusListener
     */
    public GETNOTIFICATIONSCommand(StatusListener statusListener) {
        super(statusListener);
        this.id = GETNOTIFICATIONS;
