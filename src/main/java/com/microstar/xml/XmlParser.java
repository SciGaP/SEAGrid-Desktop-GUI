...
// $Id: XmlParser.java,v 1.3 2007/11/16 20:11:30 srb Exp $
...

    ...
    throws java.lang.Exception
  {
    ...
    if (type == ATTRIBUTE_ENUMERATED || type == ATTRIBUTE_NOTATION) {
      enumerate = dataBufferToString();
    }

				// Read the default value.
    requireWhitespace();
    parseDefault(elementName, name, type, enumerate);
  }
  ...
  /**
    ...
    */
  void parseDefault (String elementName, String name, int type, String enumerate)
    throws java.lang.Exception
  {
    ...
    setAttribute(elementName, name, type, enumerate, value, valueType);
  }
